...
function renderSparklineCell(params: GridCellParams<SparkLineData, never>) {
...
export function renderAvatar(
  params: GridCellParams<{ name: string; color: string }, never, never>
) {
...
export const columns: GridColDef[] = [
  { field: "pageTitle", headerName: "Page Title", flex: 1.5, minWidth: 200 },
  {
    ...
    flex: 0.5,
    minWidth: 80,
    renderCell: (params) => renderStatus(params.value as never),
  },
  {
    field: "users",
    headerName: "Users",
